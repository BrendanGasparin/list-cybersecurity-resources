...
## Certifications and Certificates - Cybersecurity  
...
[CompTIA Network+](https://www.comptia.org/certifications/network): The CompTIA Network+ teaches core skills necessary to demonstrate your knowledge of networking and network security. It covers network fundementals, implementations, operations, security, and troubleshooting. This knowledge is neccessary for professionals who wish to work in the cybersecurity field.  
[CompTIA Security+](https://www.comptia.org/certifications/security): CompTIA's Security+ certification is a popular entry-level cybersecurity certification that demonstrates the baseline skills necessary to perform the functions of an IT security professional and pursue a career in cybersecurity. It covers general security concepts, threats, vulnerabilities, and mitigations, security architecture and operations, and security program management and oversight.  
[GIAC Information Security Fundamentals (GISF)](https://www.giac.org/certifications/information-security-fundamentals-gisf/): The GISF is an introductory certification that demonstrates knowledge of security foundations, computer function, networking, cryptography, and cybersecurity technologies. It is essentially comparable to the CompTIA A+, but with a stronger focus on security instead of general IT knowledge.  
[GIAC Security Essentials Certifice (GSEC)](https://www.giac.org/certifications/security-essentials-gsec/): The GSEC demonstrates knowledge beyond simple terminology and concepts, and validates holders for qualified IT system roles with respect to cybersecurity.  
...
[ISC2 Systems Security Certified Practitioner (SSCP)](https://www.isc2.org/Certifications/SSCP): Offered by ISC2, the Systems Security Certified Practitioner (SSCP) certification demonstrates the holder has the skills to implement, manage, and maintain information security and safeguard IT structure. It covers areas such as security operations, access controls, risk identification, incident response, cryptography, and security of systems, applications, and networks.

## Certifications - Ethical Hacking and Pentesting  
[Certified Ethical Hacker (CEH)](https://www.eccouncil.org/train-certify/certified-ethical-hacker-ceh/): The Certified Ethical Hacker (CEH) certification is offered by the EC-Council and demonstrates knowledge is assessing computer system security via ethical hacking and penetration testing. CEH holders can identify vulnerabilities in target system using the same tools as malicious hackers, but with the goal of helping organizations improve their security posture.  
[Offensive Security Certified Professional (OSCP)](https://learn.offsec.com/cybersecurity-certification-paths): This certification from Offensive Security has a focus on penetration testing and ethical hacking. OSCPs can execute real world penetration testing attacks, modify code for their own use, and before they achieve the ceritification will develop the mindset of penetration testers.  
